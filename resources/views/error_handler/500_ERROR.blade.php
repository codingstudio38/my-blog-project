...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ url('/') }}/css/500-error.css">
    ...
    <body class="antialiased">
        <div class="main-error-page">
            ...
            <h4><a class="btn btn-warning btn-sm" href="{{ route('indexpage') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i> HOME</a></h4>
