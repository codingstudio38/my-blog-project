                            ...
                            <div id="kt_app_content_container" class="app-container  container-xxl ">
                                ...
                                <div class="col-md-12" style="margin: auto;background: white;">
                                    ...
                                    <div class="col-md-12 p-3" style="margin:auto;">
                                        ...
                                        @endif
                                        <form action="{{ route('save-new-blog') }}" method="POST"
                                            ...
                                            <div class="form-outline mb-4 col-md-12" style="margin:auto;">
                                                ...
                                                <input type="file" id="photo" name="photo" onchange="checkimages()" class="form-control p-1"  accept="image/png, image/jpeg" required/>
                                                <span class="text-danger">
                                                    @error('photo')
                                                        {{ $message }}
                                                    @enderror
