@php
 ...
 $user_details = GetRowById($user->id);
...
<div id="kt_app_header" class="app-header ">
    ...
    <div class="app-container  container-fluid d-flex align-items-stretch justify-content-between "
      ...
      <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
        <a href="{{ route('user-home') }}" class="d-lg-none">
          <img alt="Logo" src="{{ url('/') }}/assets/media/logos/default-small.svg" class="theme-light-show h-30px" />
          <img alt="Logo" src="{{ url('/') }}/assets/media/logos/default-small-dark.svg" class="theme-dark-show h-30px" />
        </a>
      </div>
      <!--end::Mobile logo-->
  ...
  " id="kt_app_header_menu" data-kt-menu="true">
            ...
            <div  
              class="menu-item here show menu-here-bg menu-lg-down-accordion me-0 me-lg-2"><!--begin:Menu link--><span
                class="menu-link"><a href="{{ route('user-home') }}">Dashboards</a></span><span
            ...
            <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
              ...
              @if (!empty($user_details->photo))
                @if (file_exists(public_path('/users/'.$user_details->photo)))
                  ...
                  @else
                  <img alt="Logo" src="{{ url('/') }}/assets/images/user-unknow.jpg" />
                @endif
                @else
                <img alt="Logo" src="{{ url('/') }}/assets/images/user-unknow.jpg" />
              @endif
              ...
              <div class="menu-item px-3">
                <div class="menu-content d-flex align-items-center px-3">
                  ...
                  <div class="d-flex flex-column">
                    ...
                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7">{{ $user_details->email }}</a>
                  </div>
                  <!--end::Username-->
                </div>
              </div>
